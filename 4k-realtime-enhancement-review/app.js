  ...
  const scenes = Array.from({ length: 100 }, (_, index) => index + 1).map((number) => {
    ...
    return {
      ...
      images: {
        ...
        effect1: `./assets/effect1/${file}?v=20260916-fill-final`,
        effect2: `./assets/effect2/${file}`,
        reference2k: `./assets/reference2k/${file}`,
      },
      thumbs: {
        original: `./assets/thumbs/original/${file}`,
        effect1: `./assets/thumbs/effect1/${file}?v=20260916-fill-final`,
        effect2: `./assets/thumbs/effect2/${file}`,
        reference2k: `./assets/thumbs/reference2k/${file}`,
      },
    };
  });
