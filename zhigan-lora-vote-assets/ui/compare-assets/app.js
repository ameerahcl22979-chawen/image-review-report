(() => {
  ...
  function render() {
    ...
    app.innerHTML = `<div class="app">
      <header class="topbar"><div class="brand"><div><h1>增强幅度与色调 · 补充原色调效果对比</h1><p>低强度原色调 / 低强度暖调 / 低强度中性调 / 高强度原色调 / 高强度暖调 / 高强度中性调</p></div></div><div class="summary"><strong>${scenes.length}</strong>/ ${total} 组</div></header>
